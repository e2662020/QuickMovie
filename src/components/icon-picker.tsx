            ...
            <PopoverContent className="w-80 p-0" align="start" side="bottom" sideOffset={8}>
              <div className="flex flex-col">
                ...
                <div className="border-t p-3">
                  <label
                    className="w-full h-8 px-3 flex items-center justify-center gap-1.5 text-xs bg-secondary hover:bg-secondary/90 text-secondary-foreground rounded-md transition-colors cursor-pointer"
                    style={{ display: 'flex' }}
                  >
